    ...
    <>
      {videoData.map((data, value) => (
        <div
          ...
          key={value}
          style={{ border: "2.077px solid #000", borderRadius: "10px" }}
        >
            ...
            <div className="row">
              <div className="col-12">
                <div className="d-flex flex-column gap-4" >
                  <h5 className="text-center" style={{fontWeight:700}} >Remove Content</h5>
                  <p className="text-center" >Developing user personas will be removed from BCA ( Specialization in Data Analytics )</p>
                  <div className="d-flex align-items-center gap-3 " >
                    <button className="flex-grow-1 w-50 py-1 bg-transparent" onClick={handleClose} style={{border:"1px solid #F93333",borderRadius:"5px",color:"#f93333"}}>Keep</button>
                    <button className="flex-grow-1 w-50 py-1 bg-transparent" onClick={handleClose} style={{border:"1px solid #4AAD1B",borderRadius:"5px",color:"#4AAD1B"}}>Yes, remove</button>
                  </div>
                </div>
              </div>
            </div>
